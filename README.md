...
> **Status: Milestone 4 (Lab Notebook).** The blueprint tracker, the active-recall
> question bank, the spaced-review queue, and the lab notebook are working
> end-to-end. The dashboard is scaffolded in the nav as "coming soon" and lands in
> the next milestone.
>
...
- **M4 — Lab notebook** ✅ (this milestone) (hypothesis → change → observe → explain → next, with tags)
